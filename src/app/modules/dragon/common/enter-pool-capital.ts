...
// 标准保理 - 交易列表
export default class vankeEnterPoolConfig {
    // 地产类ABS
    static enterPoolList = {
        heads: <ListHeadsFieldOutputModel[]>[
            ...
            // { label: '交易状态', value: 'tradeStatus', type: 'tradeStatus' },
        ...
        searches: <CheckersOutputModel[]>[
            {
                title: '总部公司', checkerId: 'headquarters', type: 'select', value: '万科',
                options: { ref: 'abs_headquarters' }, required: false, sortOrder: 7, isShow: true,
            },
            {
                title: '渠道', checkerId: 'productType', type: 'linkage-select',
                options: { ref: 'productType_dw' }, required: false, sortOrder: 3
            },
            { title: '收款单位', checkerId: 'debtUnit', type: 'text', required: false, sortOrder: 10 },
            ...
            { title: '应收账款金额', checkerId: 'receive', type: 'text', required: false, sortOrder: 9 },
            {
                ...
                options: { ref: 'newdragonListType' },
                required: false,
                sortOrder: 6
            },
            { title: '付款确认书编号', checkerId: 'payConfirmId', type: 'text', required: false, sortOrder: 1 },

            { title: '交易ID', checkerId: 'mainFlowId', type: 'text', required: false, sortOrder: 1 },
            {
                title: '实际上传发票与预录入是否一致', checkerId: 'isInvoiceFlag',
                options: { ref: 'defaultRadio' }, type: 'select', required: false, sortOrder: 2
            },
            { title: '总部提单日期', checkerId: 'isHeadPreDate', type: 'dragon-loandate', required: false, sortOrder: 4 },
        ]
    };
            ...
            tabList: [
                {
                    ...
                    searches: vankeEnterPoolConfig.enterPoolList.searches,
                    headText: vankeEnterPoolConfig.enterPoolList.heads,
