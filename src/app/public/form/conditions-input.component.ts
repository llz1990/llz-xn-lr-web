...
export class ConditionsInputComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        console.log('conditions: ', this.ctrl);
        this.fromValue();
    ...
    private getConditions(enterprise) {
        ...
        this.xn.api.post('/tool/condition_list', {
            ...
            console.log('condition_list: ', json);
    ...
    addValue(conditions) {
        console.log('inconditions: ', conditions);
    ...
    private toValue() {
        ...
        console.log('ctrlV: ', this.ctrl.value);
    }
    ...
    onClear() {
        ...
        for (let row of this.ctrl.value) {
            row.checked = false;
        }
