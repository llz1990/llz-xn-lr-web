            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <!-- 行操作 -->
                        <th style='width:4%' *ngIf="row.flowId !== 'sub_nuonuocs_blue'&&row.flowId !== 'sub_nuonuocs_red'&&row.flowId !== 'sub_intermediary_delete'">操作</th>
                    </tr>
                </thead>
            </table>
        </div>
                ...
                <tbody>
                    <ng-container *ngIf="items.length>0;">
                        <tr *ngFor="let item of items;let i=index">
                            ...
                            <td style='width:4%' *ngIf="row.flowId !== 'sub_nuonuocs_blue'&&row.flowId !== 'sub_nuonuocs_red'&&row.flowId !== 'sub_intermediary_delete'">
...
export class DragonPersonListComponent implements OnInit,AfterViewInit,OnDestroy {
    ...
    public allHeads = {
        ...
        //中机构
        sub_intermediary_delete: IntermediaryManagementTabConfig.intermediaryDeleteList
    }
    ...
    viewOcrInfo(item,index){
        let checkers = this.deepCopy(DragonpaymentTabConfig.ocrConfig[QrsTypeEnum[this.ctrl_file.value]].checkers, []);;
