...
export default class ApprovalIndexTabConfig {
    ...
    static avengerapprovalLists = {
        ...
        searches: <CheckersOutputModel[]>[
            ...
            {title: '交易ID', checkerId: 'mainFlowId', type: 'date', required: false, sortOrder: 2},
            ...
            {title: '应收账款金额', checkerId: 'receive', type: 'text', required: false, sortOrder: 3},
            {title: '提单日期', checkerId: 'preDate', type: 'date', required: false, sortOrder: 3},
            {title: '保理融资到期日', checkerId: 'factoringEndDate', type: 'date', required: false, sortOrder: 3},
        ]
    };
                    ...
                    subTabList: [
                        {
                            ...
                            headText: [...ApprovalIndexTabConfig.avengerapprovalLists.heads,
                                {label: '付款确认书编号', value: 'payConfirmId', type: 'date'}],
                        },
                        {
                            label: '已上传',
                            value: 'TODO',
