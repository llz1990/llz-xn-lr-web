...
export class ContractHwNewModalComponent implements OnInit {
    ...
    open(params?: any): Observable<any> {
        ...
        if (!!params && params.edit) {
            ...
            this.rows.find(x => x.checkerId === 'contractNum')['value'] = params.data.files.contractNum;
            this.rows.find(x => x.checkerId === 'contractAmount')['value'] = params.data.files.contractAmount;
            this.rows.find(x => x.checkerId === 'img')['value'] = params.data.files.img;
            this.rows.find(x => x.checkerId === 'contractType')['value'] = params.data.files.contractType;
        }
