...
export class MachineEditComponent implements AfterViewInit, AfterViewChecked, OnInit {
    ...
    public formModule: string = 'dragon-show';
    public formModule1: string = 'dragon-input';
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe((params: Params) => {
            ...
            if (params['type'] === 'sub_zhongdeng_register') {
                this.isZD = true;
            }
        });
    }
