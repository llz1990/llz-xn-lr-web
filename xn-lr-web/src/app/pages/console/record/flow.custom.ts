...
import { PlatformAdjustOrgFlow } from '../../../avenger/flow/customer-manger/platform_adjust_org';
import { Addagreement } from '../../../avenger/flow/customer-manger/add_agreement';
import { AddCheckFile } from '../../../avenger/flow/guarante-manager/add_check_file';
import { HandlewarningMsg } from '../../../avenger/flow/guarante-manager/handle-warning-msg';
import { FinancingReportUpload } from '../../../avenger/flow/guarante-manager/financing_report_upload';
import { CreditReportUpload } from '../../../avenger/flow/guarante-manager/credit_report_upload';
import { ContractAvengerAdd } from '../../../avenger/flow/contract-manage/contract_avenger_add';
import { ContractAvengeredit } from '../../../avenger/flow/contract-manage/contract_avenger_edit';
...
export class FlowCustom {
    static build(
        ...
        switch (name) {
            ...
            case 'contract_rule_add':
                return new ContractRuleAddFlow(xn);   // 合同模板添加
            case 'contract_avenger_add':
                return new ContractAvengerAdd(xn, loading); //合同管理万科编辑
            case 'contract_rule_edit':
                return new ContractRuleEditFlow(xn); // 合同模板地产编辑
            case 'contract_avenger_edit':
                return new ContractAvengeredit(xn, loading);//合同模板万科编辑
            ...
            // case 'platform_adjust_org':
            //     return new PlatAdjustorg(xn, loading);
            default:
