...
export class ContractInputComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        console.log('contractCtrl: ', this.ctrl);
        console.log('contractRow: ', this.row);
        this.fromValue();
    ...
    private fromValue() {
        ...
        console.log('contractItems: ', this.items);
    ...
    toValue() {
        if (this.items.length === 0) {
            ...
            console.log('itemsTOValue: ', this.items);
            ...
            console.log('numberChange: ', this.numberChange);
            console.log('supplierChange: ', this.supplierChange);
        }
