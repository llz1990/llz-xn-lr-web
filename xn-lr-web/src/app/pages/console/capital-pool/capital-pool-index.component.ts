...
import { CapitalPoolNameModalComponent } from '../../../public/modal/capital-pool-name-modal.component';
import { FormGroup } from '@angular/forms';
import { XnFormUtils } from '../../../common/xn-form-utils';
import { CapitalPoolAlertRatioModalComponent } from '../../../public/modal/capital-pool-alert-ratio-modal.component';
import { CapitalPoolIntermediaryAgencyModalComponent } from '../../../public/modal/capital-pool-intermediary-agency-modal.component';
    ...
    public onPage(page: number) {
        ...
        if (this.isAgencyUser) {
            params.where = {
                _complex: {
                    _logic: 'AND',
                    isProxy: ['IN', [6, 14]], // 交易模式（万科模式: 6 , 金地模式: 14 ）
