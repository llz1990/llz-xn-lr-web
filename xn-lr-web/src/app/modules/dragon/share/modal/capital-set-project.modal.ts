...
export class CapitalPoolsetProjectPlanModalComponent implements OnInit {
    ...
    open(params: any): Observable<string> {
        console.log('资产池(龙光) 绑定信息:', params);
        if (params.type === 2) {
            this.params = params;
            ...
            this.title = '修改发行要素';
            this.params = { ...params.project, type: 1 };
        }
            ...
            this.shows = [
                ...
                },
                {
                    ...
                    value: this.params.type === 2 ? JSON.stringify({
                        ...
                        capitalPeriodNum: '', // 资产管理计划期数
                        capitalManageNum: '', // 资产管理计划编号
                        applyExpires: '',  //申请期限
    ...
    public onSubmit() {
        ...
        if (this.params.type === 2) {
            let params = { ...params1, project_manage_id: this.projectId };
            this.xn.api.dragon
            ...
            let params2 = { ...params1, capitalPoolId: this.params.capitalPoolId };
            this.xn.api.dragon
