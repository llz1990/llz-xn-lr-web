...
export class RejectModalComponent {
    ...
    public handleSubmit() {
        let newObj = {
            'contract': this.rejectInfo[0].contract, 'invoice': this.rejectInfo[1].invoice,
            'certificateFile': this.rejectInfo[2].certificateFile, 'otherFile': this.rejectInfo[3].otherFile
        };
