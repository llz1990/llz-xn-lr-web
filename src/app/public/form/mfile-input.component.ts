...
import { AvengerPdfSignModalComponent } from '../../avenger/shared/components/modal/pdf-sign-modal.component';
declare let $: any;
...
export class MfileInputComponent implements OnInit {
    ...
    public showContract(id: string, secret: string, label: string) {
        if (this.svrConfig.mainFlowId !== undefined) {
            if ((this.svrConfig.mainFlowId.endsWith('wk')
                || this.svrConfig.mainFlowId.endsWith('lg'))) {
            ...
            if ((this.svrConfig.record.mainFlowId.endsWith('wk')
    ...
    public onView(item: any) {
        ...
        if (!!this.svrConfig) {
            if (this.svrConfig.mainFlowId !== undefined && (this.svrConfig.mainFlowId.endsWith('wk')
                || this.svrConfig.mainFlowId.endsWith('lg'))) {
                XnModalUtils.openInViewContainer(this.xn, this.vcr, DragonMfilesViewModalComponent, [item]).subscribe(x => {

                });
            } else
                if (this.svrConfig.record !== undefined && (this.svrConfig.record.mainFlowId.endsWith('wk')
                    || this.svrConfig.record.mainFlowId.endsWith('lg'))) {
                    XnModalUtils.openInViewContainer(this.xn, this.vcr, DragonMfilesViewModalComponent, [item]).subscribe(x => {
