export class XnAsset {
    ...
    static convertAsset(obj) {
        ...
        let purchase_orderTimeArr: any = [];
        let supply_orderTimeArr: any = [];
        let stock_inTimeArr: any = [];
        let stock_outTimeArr: any = [];
        let transfer_stockTimeArr: any = [];
        let purchase_financeTimeArr: any = [];
        let supply_financeTimeArr: any = [];
        ...
        let dai_ding = obj.assetCount - supply_order;
        let ding_dan = supply_order - stock_in;
        let ku_cun = stock_in - (stock_out + transfer_stock);
        let chu_ku = stock_out;
        let ji_ku = transfer_stock;
        ...
        return {
            ...
            chu_ku: chu_ku,
            ji_ku: ji_ku,
            purchase_orderTimeArr: purchase_orderTimeArr,
            supply_orderTimeArr: supply_orderTimeArr,
            stock_inTimeArr: stock_inTimeArr,
            stock_outTimeArr: stock_outTimeArr,
            transfer_stockTimeArr: transfer_stockTimeArr,
            purchase_financeTimeArr: purchase_financeTimeArr,
            supply_financeTimeArr: supply_financeTimeArr,
            logs: obj.logs,
