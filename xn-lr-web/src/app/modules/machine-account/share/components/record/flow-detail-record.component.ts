...
import { MachinePdfSignModalComponent } from '../../modal/pdf-sign-modal.component';
...
@Component({
    selector: 'xn-machine-flow-detail-record-component',
...
export class FlowDetailRecordComponent implements OnInit {
   ...
   */
    ...
    public showContract(paramCurrentContract: any): void {
        XnModalUtils.openInViewContainer(this.xn, this.vcr, MachinePdfSignModalComponent, {
