...
import { XnInputComponent } from '../../../public/form/xn-input.component';
...
export class CustomerChangeManagerComponent implements OnInit {
    ...
    public onSubmit() {
        ...
        this.xn.api.post('/custom/avenger/customer_manager/adjust_manager', {
            ...
            if (data.ret === 0) {
                this.xn.router.navigate(['/console/customer-manage']);
                return;
            }
        });
    }
