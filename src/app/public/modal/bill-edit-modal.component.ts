...
export class BillEditModalComponent implements OnInit {
    ...
    onSelect(item) {
        ...
        let keys: any = [];
        for (var key in this.mainForm.value) {
            keys.push(key);
        }
        ...
        console.log('this.params: ', this.params);
        this.buildForm();
        console.log('lastForm: ', this.mainForm.value);
    }
    ...
    onSubmit() {
        console.log('this.mainForm.value: ', this.mainForm.value);
        console.log('this.params: ', this.params);
        // for(let segistration of this.taxpayerSegistrationNumbers) {
        //     if(this.mainForm.value.taxpayerSegistrationNumber === segistration) {
