...
import { ApprovalAddModalComponent } from '../../../public/modal/approval-add-modal.component';
import { ApprovalEditModalComponent } from '../../../public/modal/approval-edit-modal.component';
import { ApprovalReadModalComponent } from '../../../public/modal/approval-read-modal.component';
import { ApprovalDeleteModalComponent } from '../../../public/modal/approval-delete-modal.component';
...
export class ApprovalConditionsComponent implements OnInit {
    ...
    getCondition() {
        this.xn.api.post('/tool/condition_all', {
            ...
            console.log('condition_all:', json);
