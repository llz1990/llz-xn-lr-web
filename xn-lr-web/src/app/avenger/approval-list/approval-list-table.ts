...
export default class ApprovallistIndexTabConfig {
    // 交易列表 -采购融资，默认配置
    static normalbusiness = {
        ...
        searches: <CheckersOutputModel[]>[
            ...
            { title: '提单日期', checkerId: 'startTime', type: 'quantum1', required: false, sortOrder: 10 },
            {
    ...
    static searcherCommon = {
        searches: <CheckersOutputModel[]>[
            ...
            { title: '提单日期', checkerId: 'startTime', type: 'quantum1', required: false, sortOrder: 8 },
            { title: '起息日', checkerId: 'valueDate', type: 'quantum1', required: false, sortOrder: 8 },
            { title: '付款银行', checkerId: 'payBankName', type: 'text', required: false, sortOrder: 13 },
            { title: '付款银行账号', checkerId: 'payBankAccount', type: 'text', required: false, sortOrder: 14 },
            { title: '资金渠道', checkerId: 'channelType', type: 'select', options: { ref: 'moneyChannel' }, required: false, sortOrder: 14 },
                    ...
                    subTabList: [
                        {
                            ...
                            edit: {
                                ...
                                rowButtons: [
                                    ...
                                    //         // 拼接文件
                                    //         xn.router.navigate([`/console/record/avenger/new/sub_approval_stop`],
                                    //             {
                                    //                 queryParams: {
                                    //                     id: 'sub_approval_stop',
                                    //                     relate: 'mainFlowId',
                                    //                     relateValue: params.mainFlowId,
                                    //                 }
                                    //             });
                            ...
                            searches: ApprovallistIndexTabConfig.normalbusiness.searches,
                            headText: [...ApprovallistIndexTabConfig.normalbusiness.heads,
                                { label: '付款申请表', value: 'receivetable', type: 'contract' },
                        ],
                        },

                        {
                            ...
                            searches: ApprovallistIndexTabConfig.SpecialBusinesslist.searches,
                            headText: [...ApprovallistIndexTabConfig.SpecialBusinesslist.heads,
                                   { label: '付款申请表', value: 'receivetable', type: 'contract' },
                    ...
                    subTabList: [
                        {
                            ...
                            searches: ApprovallistIndexTabConfig.approvalBusinesslist.searches,
                            headText: [...ApprovallistIndexTabConfig.approvalBusinesslist.heads,
                    ...
                    subTabList: [
                        {
                            ...
                            searches: ApprovallistIndexTabConfig.readySigncontract.searches,
                            headText: [...ApprovallistIndexTabConfig.readySigncontract.heads, {
                    ...
                    subTabList: [
                        {
                            ...
                            searches: [...ApprovallistIndexTabConfig.searcherCommon.searches,
                            {
                            ...
                            headText: [...ApprovallistIndexTabConfig.headscommon.heads,
                            { label: '应收账款转让协议', value: 'receiveFiles', type: 'contract' },
                            { label: '起息日', value: 'valueDate', type: 'date' },
                            { label: '保理融资到期日', value: 'factoringEndDate', type: 'date' },
                            { label: '转让价格', value: 'changePrice', type: 'receivable' },
                            { label: '付款申请表', value: 'receivetable', type: 'contract' },
                    ...
                    subTabList: [
                        {
                            ...
                            { label: '起息日', value: 'valueDate', type: 'date' },
                            { label: '付款申请表', value: 'receivetable', type: 'contract' },
                            { label: '实际放款日', value: 'loanDate', type: 'date' },
                            { label: '费用情况', value: 'feeStatus', type: 'freeType' },
