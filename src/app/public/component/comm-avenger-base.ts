...
export default class AvengerCommBase {
    ...
    onList(params, type) {
        if (type === 'A' && this.superConfig.list && this.superConfig.list.onList) {
            this.superConfig.list.onList(this, params);
        } else if (type === 'B' && this.superConfig.list && this.superConfig.list.avengeronList) {
            this.superConfig.list.avengeronList(this, params);
