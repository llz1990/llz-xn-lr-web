...
export class TemplateComponent implements OnInit {
    ...
    ngOnInit() {
        this.flowTable = new FlowDataTable(this.xn, '#flowTable', 'flow-template');
    ...
    private onSelectFlow(e) {
        ...
        this.procedureTable = new ProcedureDataTable(this.xn, '#procedureTable', 'procedure-template', {
            where: {
                flowId: data.flowId
            }
        });
    ...
    private onSelectProcedure(e) {
        ...
        this.checkerTable = new DataTable(this.xn, '#checkerTable', 'checker-template', {
            where: {
