...
export default class IndexTabConfig {
    ...
    static BankCustomLists = {
        heads: <ListHeadsFieldOutputModel[]>[
            {
                label: '企业名称', value: 'orgName', _inList: {
                    sort: true,
                    search: true
                },
            },
            {
                label: '白名单状态', value: 'whiteStatus', _inList: {
                    sort: true,
                    search: true
                }, type: 'bankWhiteStatus',
            },
            {
                label: '省份', value: 'province', _inList: {
                    sort: false,
                    search: true
                },
            },
            {
                label: '市', value: 'city', _inList: {
                    sort: false,
                    search: true
                }
            },
            {
                label: '费率(%)', value: 'rate', type: 'correctMoney', _inList: {
                    sort: false,
                    search: true
                },
            },
            {
                label: '最大期限（天）', value: 'dateLimit', _inList: {
                    sort: false,
                    search: true
                }
            },
            {
                label: '最大额度(元)', value: 'loanLimit', type: 'money', _inList: {
                    sort: false,
                    search: true
                }
            },
            {
                label: '推广状态', value: 'pushStatus', _inList: {
                    sort: true,
                    search: true
                },
                type: 'pushStatus',
            ...
            {
                label: '是否签署协议', value: 'statusCompany', type: 'contract', _inList: {
                    sort: false,
                    search: true
                },
            },
            {
                label: '银行授信文件', value: 'bankAccreditFile', type: 'file', _inList: {
                    sort: false,
                    search: true
                },
            },
            {
                label: '银行批复文件', value: 'bankReplyFile', type: 'file', _inList: {
                    sort: false,
                    search: true
                },
            },
            {
                label: '融资文件', value: 'financingFile', type: 'file', _inList: {
                    sort: false,
                    search: true
                }
            },
            {
                label: '其他文件', value: 'otherFile', type: 'file', _inList: {
                    sort: false,
                    search: true
                }
            }
        ...
        searches: <CheckersOutputModel[]>[
            { title: '企业名称', checkerId: 'orgName', type: 'text', required: false, sortOrder: 1 },
            { title: '省份', checkerId: 'province', type: 'text', required: false, sortOrder: 2 },
            { title: '市', checkerId: 'city', type: 'text', required: false, sortOrder: 3 },
            {
                title: '《推介函》状态', checkerId: 'pushStatus', type: 'select', options: { ref: 'pushStatus' },
                required: false, sortOrder: 4
            },
            { title: '最大期限范围（天）', checkerId: 'day', type: 'number-range', required: false, sortOrder: 5 },
            { title: '最大额度范围（元）', checkerId: 'receive', type: 'number-range', required: false, sortOrder: 6 },
            {
                title: '银行授信文件', checkerId: 'statusBankAccreditFile', type: 'select',
                options: { ref: 'accountReceipts' }, required: false, sortOrder: 7
            },
            {
                title: '银行批复文件', checkerId: 'statusBankReplyFile', type: 'select',
                options: { ref: 'accountReceipts' }, required: false, sortOrder: 8
            },
            {
                title: '融资文件', checkerId: 'statusFinancingFile', type: 'select',
                options: { ref: 'accountReceipts' }, required: false, sortOrder: 9
            },
            {
                title: '是否签署协议', checkerId: 'signAgreementStatus', type: 'select',
                options: { ref: 'bussStatus' }, required: false, sortOrder: 10
            },
            {
                title: '白名单状态', checkerId: 'whiteStatus', type: 'select',
                options: { ref: 'BankwhiteNameStatus' }, required: false, sortOrder: 11
            },
            { title: '费率范围（%）', checkerId: 'rateRange', type: 'number-range', required: false, sortOrder: 12 },
                                ...
                                rowButtons: [
                                    {
                                        ...
                                        click: (base: CommBase, params, xn: XnService, hwModeService: HwModeService) => {
                                            ...
                                            if (!(rolesArr && rolesArr.length)) {
                                                xn.msgBox.open(false, '您好，您的权限不够，仅【客户经理经办人、客户经理复核人】可进行操作');
                                            } else {
                                                xn.router.navigate([`/console/bank-puhuitong/record/new`],
                                                    {
                                                        queryParams: {
