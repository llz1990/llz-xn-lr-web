import { Component, Input, OnInit,ElementRef,ViewContainerRef,ViewChild } from '@angular/core';
...
export class CompanyDetailUploadComponent implements OnInit {
    @Input() row: any;
    ...
    formResize(){
        ...
        let col8Left = ($parentForm.children('.col-sm-8').outerWidth(true) - $parentForm.children('.col-sm-8').width())/2;
        //设置当前元素样式
