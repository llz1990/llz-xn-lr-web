...
export class MoneyTableComponent implements OnInit {
    ...
    getNowMonthIndex(rows, nowMonth) {
        ...
        console.log('nowMonthIndex: ', this.nowMonthIndex);
    ...
    getSum(arr) {
        ...
        console.log('sum: ', sum);
        console.log('sumMap: ', sum.map(v => v.toFixed(2)));
    ...
    getLastYear() {
        ...
        console.log('rows: ', rows.filter(v =>  Number(v.month) >= 1710));
