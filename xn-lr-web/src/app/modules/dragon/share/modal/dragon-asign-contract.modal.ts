...
export class DragonFinancingContractModalComponent implements OnInit {
    ...
    */
    ...
    private createOcx() {
        ...
        console.info('this.ocx==>', this.ocx);

        this.ocx.OnOpenFile = () => {
            console.info('===>OnOpenFile');
        };
        this.ocx.OnDoSealSuccess = () => {
            console.info('===>OnDoSealSuccess');
        ...
        this.ocx.OnStartWaiting = () => {
            console.info('===>OnStartWaiting ');
        };
        this.ocx.OnEndWait = () => {
            console.info('===>OnEndWait ');
        };
        this.ocx.OnPrePubSeal = () => {
            console.info('===>OnPrePubSeal ');
        };
        this.ocx.OnPrePagingSeal = () => {
            console.info('===>OnPrePagingSeal ');
        };
        this.ocx.OnPreHandWrite = () => {
            console.info('===>OnPreHandWrite ');
        };
        this.ocx.OnBookMarkSwitch = () => {
            console.info('===>OnBookMarkSwitch ');
        };
        this.ocx.OnPageNoChanged = () => {
            console.info('===>OnPageNoChanged ');
        };
        this.ocx.OnDeleteSeal = () => {
            console.info('===>OnDeleteSeal ');
        };
        this.showOrHide();
    }
