...
@Component({
    selector: 'vanke-business-related',
    templateUrl: './vanke-business-related.component.html',
    styles: [
        `
            .table {
                font-size: 13px;
...
export class VankebusinessComponent implements OnInit {
    ...
    viewRecord(record: string, type?: string) {
        if (type && type === 'avenger') {
            ...
            this.xn.router.navigate([`/dragon/record/todo/view/${record}`]);
        }
    }
