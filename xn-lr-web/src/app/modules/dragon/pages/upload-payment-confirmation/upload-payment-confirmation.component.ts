 ...
 * 1.0                 wangqing          龙光上传付确         2019-09-19
 * **********************************************************************
 */
...
export class DragonUploadPaymentsComponent implements OnInit {
    tabConfig: any;
  ...
  */
    ...
    private buildCondition(searches) {
        ...
        for (let i = 0; i < searches.length; i++) {
            ...
            if (this.timeStorage.timeId.includes(searches[i]['checkerId'])) {
                let checkIndex = this.timeStorage.timeId.findIndex((time) => time === searches[i]['checkerId']);
                let tmpTime = this.timeStorage[this.timeStorage.timeId[checkIndex]];
    ...
    private buildParams(flag, type) {
        ...
        const params: any = {
            ...
            flag: flag,
            modelType: typeEnum[type]      //模式类型 1=龙光 2=万科 3=雅居乐
        };
        // 排序处理
