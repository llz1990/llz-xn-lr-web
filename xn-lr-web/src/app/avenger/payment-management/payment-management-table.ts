...
export default class PaymentIndexTabConfig {
    ...
    static paymentLists = {
        ...
        searches: <CheckersOutputModel[]>[
            ...
            { title: '应收账款金额', checkerId: 'receivable', type: 'text', required: false, sortOrder: 3 },
            { title: '万科供应商', checkerId: 'projectCompany', type: 'text', required: false, sortOrder: 6 },
            { title: '合同编号', checkerId: 'contractNum', type: 'text', required: false, sortOrder: 3 },
            { title: '上游客户', checkerId: 'debtUnit', type: 'text', required: false, sortOrder: 3 },
            { title: '商票号码', checkerId: 'honorNum', type: 'text', required: false, sortOrder: 3 },
            { title: '保理融资起始日', checkerId: 'valueDate', type: 'quantum', required: false, sortOrder: 3 },
            { title: '保理融资到期日', checkerId: 'factoringEndDate', type: 'quantum', required: false, sortOrder: 3 },
    ...
    static abs = {
        heads: <ListHeadsFieldOutputModel[]>[
            ...
            { label: '付款确认书', value: 'debtReceivableType', type: 'xnContractType' },
            { label: '付确匹配方式', value: 'capitalPoolName' },
        ],
        searches: <CheckersOutputModel[]>[
            { title: '资产池名称', checkerId: 'createTime', type: 'date', required: false, sortOrder: 2 },
            { title: '交易ID', checkerId: 'customerName', type: 'text', required: false, sortOrder: 3 },
            { title: '付款确认书编号', checkerId: 'amount', type: 'text', required: false, sortOrder: 6 },
            { title: '总部公司', checkerId: 'customerName', type: 'text', required: false, sortOrder: 3 },
            { title: '收款单位', checkerId: 'customerName', type: 'text', required: false, sortOrder: 3 },
            { title: '应收账款金额', checkerId: 'customerName', type: 'text', required: false, sortOrder: 3 },
            { title: '提单日期', checkerId: 'customerName', type: 'text', required: false, sortOrder: 3 },
            { title: '保理融资到期日', checkerId: 'factoringEndDate', type: 'quantum', required: false, sortOrder: 3 },
        ]
    };
    // >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
