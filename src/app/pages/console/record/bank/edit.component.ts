...
export class BankEditComponent implements OnInit, AfterViewInit {
    ...
    onSubmit() {
        this.innerSubmit(() => {
            ...
            console.log('formEdit:', this.mainForm.value);
