...
import { ShowPhotoModalComponent } from '../../../public/modal/show-photo-modal.component';
...
export class FlowDetailChartComponent implements OnInit {
    ...
    private goAsset(index) {
        ...
        console.log('this.nowAsset', this.nowAsset);
        if (this.nowAsset && this.nowAsset.logs && this.nowAsset.logs.length) {
            ...
            if (this.entrustmentList && this.entrustmentList.length) {
                ...
                console.log('ent', this.entrustmentList);
            }
    ...
    private sliceShow(start, end) {
        ...
        console.log('截取nowAsset:', this.nowAsset);
        setTimeout(() => {
            // 调整页面下半部分
            this.showDown();
