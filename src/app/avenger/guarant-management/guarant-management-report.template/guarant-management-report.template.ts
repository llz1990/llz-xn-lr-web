...
export class GuarantManagementReportTemplateComponent implements OnInit {
    ...
    type: string = '';
    fileType: number = 1;
    CONST01: string = 'get-report';
    CONST02: string = 'view-exceptions';
    ...
    openCompanyDetail(item: any) {
        this.xn.router.navigate([`/console/guarant-manage/report-detail`],
    ...
    openCheckDetail(item: any) {
        ...
        //         }
        //     });
        this.xn.router.navigate([`/console/guarant-manage/check-detail`],
