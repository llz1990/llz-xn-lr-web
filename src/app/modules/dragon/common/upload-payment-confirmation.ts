...
export default class DragonpaymentTabConfig {
    ...
    static personMatch = {
        ...
        '深圳市龙光控股有限公司': { //深圳市龙光控股有限公司 - 《付款确认书（总部致保理商）》、《付款确认书（总部致券商）》
            heads: <ListHeadsFieldOutputModel[]>[
                { label: '交易ID', value: 'mainFlowId', type: 'mainFlowId', width: '14%' },
                { label: '付款确认书（总部致保理商）合同编号', value: 'codeFactoringPayConfirm', type: 'text', width: '10%' },
                ...
                { label: '应收账款金额', value: 'receive', width: '5%' },
                { label: '保理融资到期日', value: 'factoringEndDate', type: 'date', width: '5%' },
                { label: '付款确认书（总部致保理商）影印件', value: 'factoringPayConfirmYyj', type: 'file', width: '10%' },
    ...
    static systemMatch = {
        ...
        dragon1: { //深圳市龙光控股有限公司 - 《付款确认书（总部致保理商）》
            /**
                    ...
                    subTabList: [
                        {
                                ...
                                headButtons: [
                                    {
                                        ...
                                        click: (xn: XnService, params) => {
                                            ...
                                            if (!(rolesArr && rolesArr.length)) {
                                                ...
                                                xn.router.navigate([`/dragon/record/new/`],
                                                    {
                                                        queryParams: {
                            ...
                            { label: '付款确认书影印件', value: 'pdfProjectFiles', type: 'file' },
