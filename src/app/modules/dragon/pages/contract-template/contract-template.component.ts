...
import onceContractTemplateTab from '../../../dragon/common/once-contract-template.tab';
declare const moment: any;

@Component({
    selector: 'app-contract-management-component',
...
export class TransferContractManagerComponent implements OnInit {
    tabConfig: any;
    ...
    public onPage(e?: { page: number, first?: number, pageSize?: number, pageCount?: number }) {
        ...
        || this.tabConfig.value === 'second_contract_manage' && this.defaultValue==='A'){
            let init_url = 'once_contract_manage' && this.defaultValue==='B'?'/contract/first_contract_info/init_first_template':'/contract/second_contract_info/init_second_template';
  ...
  */
    ...
    public handleHeadClick(paramBtnOperate: ButtonConfigModel) {
        console.log("yy==",paramBtnOperate);
