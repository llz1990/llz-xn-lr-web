...
export class TselectInputComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        console.log('value: ', this.ctrl.value);
        console.log('factoryId****: ', this.factory);
        this.getFirstValue();
        // this.getSecondValue();
        // this.getThreeValue();
        ...
        // 设置初始值
        if (this.ctrl.value) {
            let value = XnUtils.parseObject(this.ctrl.value);
    ...
    getFirstValue() {
        this.xn.api.post('/tool/wk', {
            ...
            console.log('getFirstValue: ', json);
    ...
    getSecondValue(name) {
        this.xn.api.post('/tool/wk1', {
            ...
            console.log('getSecondValue: ', json);
    ...
    getThreeValue(name1, name2) {
        this.xn.api.post('/tool/wk2', {
            ...
            console.log('getThreeValue: ', json);
            if (json.data.length <= 0) {
                this.clear3();
            }
    ...
    onFirstChange(event) {
        ...
        if (this.firstValue === '') {
            ...
            console.log('secondOptions： ', this.secondOptions);
