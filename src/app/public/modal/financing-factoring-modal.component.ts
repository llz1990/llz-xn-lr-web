...
export class FinancingFactoringModalComponent implements OnInit {
    ...
    open(params: any): Observable<string> {
        ...
        console.log('confirmContract: ', this.params);
        if (this.leader) {
            this.shows = [];
            this.hides = [];
            this.hides.push({
    ...
    onOk() {
        // TODO 验证验证码
        console.log('code: ', this.mainForm && this.mainForm.value && this.mainForm.value.code);
        console.log('mobile: ', this.leader && this.leader.mobile);
        if (!!this.leader) {
