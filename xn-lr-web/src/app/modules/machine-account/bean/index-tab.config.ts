...
export default class MachineIndexTabConfig {
    ...
    static MachineaccountTab = {
        ...
        platHeads: <ListHeadsFieldOutputModel[]>[{
            label: '交易ID', value: 'mainFlowId', type: 'mainFlowId', _inList: {
                sort: true,
                search: true
            },
        ...
        searches: <CheckersOutputModel[]>[
            ...
            // {
            //     title: '预计放款日期', checkerId: 'ExpectedDate', type: 'machine-loandate',
            //     required: false, sortOrder: 12
            // },
        ]
    };
    ...
    static readonly config = {
        ...
        platmachineAccount: <TabConfigModel>{
            title: '台账列表',
            tabList: [
        ...
        suppliermachineAccount: <TabConfigModel>{
            title: '台账列表',
            tabList: [
                {
                    label: '地产类业务',
