...
@Component({
    templateUrl: './capital-map.component.html',
    styles: []
})
export class CapitalMapComponent implements OnInit {
    ...
    ngOnInit() {
            ...
            series: [
                {
                    type: 'sankey',
                    layout: 'none',
                    data: productJson.nodes,
                    links: productJson.links,
                    itemStyle: {
                        normal: {
                            borderWidth: 1,
                            borderColor: '#aaa'
        ...
        // $http({
        //     method: 'GET',
        //     url: 'http://echarts.baidu.com/data/asset/data/les-miserables.gexf'
