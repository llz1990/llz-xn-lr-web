 ...
 * All rights reserved.
 *
 * @file：performance-input.component.ts
 * @summary：地产abs保理商补充履约证明文件
 * @version: 1.0
 * **********************************************************************
 * revision             author            reason             date
 * 1.0                 zhyuanan          修改取默认值方式         2019-05-13
 * 1.2                 zhyuanan      仅当总部公司为雅居乐默认取值  2019-05-16
 * **********************************************************************
 */
...
@Component({
    selector: 'app-xn-performance-input',
...
export class PerformanceInputComponent implements OnInit {
     ...
     */
    private fromValue() {
        if (this.headquartersCtrl.value && this.headquartersCtrl.value === '雅居乐地产控股有限公司') {
