...
export class DragonInvoiceManagementComponent implements OnInit {
     ...
     * @param paramFile
     */
    public downloadFiles(fileId,mainFlowId) {
        console.log("01==",fileId,mainFlowId);
        this.xn.avenger.post('/file/nuonuofp',{
        // this.xn.avenger.download('/file/nuonuofp',{
            mainFlowId: mainFlowId,
            id: fileId
        }).subscribe((x: any) => {
            console.log("00==",x);
            this.xn.api.save(x._body, '开票文件.pdf');
        });
    }
