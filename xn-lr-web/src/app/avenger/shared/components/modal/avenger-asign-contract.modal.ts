...
import { ModalSize, ModalComponent } from '../../../../common/modal/ng2-bs3-modal';

@Component({
    selector: 'app-financing-factoring-vanke-modal',
    templateUrl: './avenger-asign-contract.modal.html',
    styles: [
        `
            .pdf-container {
                width: 100%;
...
export class AvengerFinancingContractModalComponent implements OnInit {
