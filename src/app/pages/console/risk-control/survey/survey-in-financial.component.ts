...
export class SurveyInFinancialComponent implements OnInit {
    ...
    handleChange(e, index: number) {
        ...
        console.log('表头缓存：', this.titleModel);
    ...
    init(startTime, endTime, index) {
        const postData = {
            ...
            params_balance: {orgName: this.customerInfo.orgName, endTime: endTime},
            params_profit: {orgName: this.customerInfo.orgName, startTime: startTime, endTime: endTime},
            params_cash: {orgName: this.customerInfo.orgName, startTime: startTime, endTime: endTime},
        };
        ...
        if (!!endTime) {
            ...
            this.xn.api.post(postData[`url_${this.classify}`], postData[`params_${this.classify}`]).subscribe(x => {
                ...
                if (x.data && x.data.length) {
                    ...
                    console.log(this.info[this.classify]);
                    // 保存值到缓存
