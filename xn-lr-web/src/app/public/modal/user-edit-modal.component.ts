...
export class UserEditModalComponent implements OnInit {
    ...
    open(params: any): Observable<string> {
        ...
        // 给保理商和平台开放风控，核心企业也加上
        else if ((this.roleArr.indexOf('admin') === -1) && (this.xn.user.orgType === 2)) {
            selectOptionsArr = [
                { label: '业务经办人', value: 'operator' },
                { label: '业务复核人', value: 'reviewer' },
    ...
    onSubmit() {
        ...
        let ctrlValueArr = this.mainForm.value.userRoleList && this.mainForm.value.userRoleList.split(',');
    ...
    postEdit() {
        ...
        console.log('editFormValue: ', this.mainForm.value);
