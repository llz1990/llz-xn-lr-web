    ...
    preSubmit(svrConfig: any, formValue: any): Observable<any> {
        ...
        if (svrConfig.procedure.procedureId !== 'review') {
            ...
            try {
                ...
                let amount = contractFile.reduce((total, next) => {
            ...
            try {
                ...
                let amount = invoiceFile.reduce((total, next) => {
        ...
        if (svrConfig.actions[0].checkers[0].data === '雅居乐地产控股有限公司' && this.xn.user.orgType === 1) {
            return Observable.of(null);
        }
