 ...
 */
DataTable.Editor.defaults.display = "xiangna";
...
DataTable.Editor.display.xiangna = $.extend( true, {}, DataTable.Editor.models.displayController, {
	/*
	 * API methods
	 */
	"init": function ( dte ) {
...
self = DataTable.Editor.display.xiangna;
