...
import { acceptedRoutes } from './config/reuse-routes';
...
export class CustomReuseStrategy implements RouteReuseStrategy {
    private acceptedRoutes = acceptedRoutes;
    ...
    shouldAttach(route: ActivatedRouteSnapshot): boolean {
        ...
        if (canAttach) {
            ...
            const handle = this.storedRoutes[route.routeConfig.path].handle;
            if (
                handle &&
                handle['componentRef'] &&
                handle['componentRef'].instance &&
                handle['componentRef'].instance.refreshDataAfterAttachComponent
            ) {
                // console.log('refresh data after attach component....');
