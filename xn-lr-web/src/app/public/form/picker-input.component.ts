...
export class PickerInputComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        console.log('boolean: ', this.ctrlChange);
        console.log('value: ', this.form.get(this.row.name).value);
        ...
        let arr = this.row.options.change;
        console.log('arr: ', arr);
    ...
    private fromValue() {
        if (!this.ctrlChange) {
            ...
            if (this.isCard) {
                ...
                console.log('thisCrlValue: ', this.ctrl.value);
    ...
    private getData(obj) {
        ...
        this.xn.api.post(`${url}/?method=get`, {
            ...
            if (this.row.options && this.row.options.tochange) {
                for (let row of this.row.options.tochange) {
