...
import { ContractAddCompanyModalComponent } from '../../avenger/contract-manage/add-cotracttemplate/add-contracttemplate.component';
// tslint:disable-next-line:max-line-length
import { CustomerAddCompanyModalComponent } from '../../avenger/customer-manage/customer-addCompany-template/customer-addCompany.modal.component';
...
import { AvengerFinancingContractModalComponent } from './components/modal/avenger-asign-contract.modal';
import { AvengerPdfSignModalComponent } from './components/modal/pdf-sign-modal.component';
import { ShowForms } from './components/form/show/indext';
import { ChoseManageModalComponent } from '../../avenger/guarant-management/guarant-add-manage.template/guarant-add-manage.template.modal';
